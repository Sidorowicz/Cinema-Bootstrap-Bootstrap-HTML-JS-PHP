...
<div id="legenda"><div class="f">Wolne miejsca:</div> <div class="kolob"></div>	<div class="f">Zajęte miejsca:</div><div class="kolos"></div>	<div class="f">Wybrane Miejsca:</div><div class="koloc">.</div>
</div>
<form action="conf3.php" method="post">
<input type="hidden" id="arr" name="arr">
<button id="reser2">Zarezerwuj</button>
</form>
